...
def get_parser():
    ...
    parser.add_argument('--eval_pkl', type=str)
    parser.add_argument('--train_base_lr', type=float, default=0.1)
    ...
    parser.add_argument('--joint_sign', type=str, default='processed')
    parser.add_argument('--joint_type', type=str, default='27_direct')
