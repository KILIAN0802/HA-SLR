...
"""
$ python ensemble_wo_val_final_val.py
100%|███████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 4418/4418 [00:00<00:00, 16591.06it/s]
4418
top1:  0.9545043005885016
top5:  0.9925305568130376
"""

with open('./data/MultiVSL200_27/test_label.pkl', 'rb') as f:
    sample_names, labels = pickle.load(f)
label = np.array([sample_names, labels])
...
with open('predictions_wo_val_final_val.csv', 'w') as f:
...
# with open('./gcn_ensembled_final_val.pkl', 'wb') as f:
