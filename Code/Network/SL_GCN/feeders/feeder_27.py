...
class Feeder(Dataset):
    def __init__(self, data_path, label_path,
        ...
        :param data_path: 
        :param label_path: 
        :param random_choose: If true, randomly choose a portion of the input sequence   随机选择视频起始点  TemporalRandomCrop
        :param random_shift: If true, randomly pad zeros at the begining or end of sequence  # 随机偏移，偏移片段用0填充
        :param random_move: 
    ...
    def __getitem__(self, index):
        data_numpy = self.data[index]  # 单一样例的视频信息
        ...
        if self.random_mirror:
            if random.random() > self.random_mirror_p:
                ...
                if self.is_vector:
                    ...
                    data_numpy[0,:,:,:] = 512 - data_numpy[0,:,:,:]   # 512...
